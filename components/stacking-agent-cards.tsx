...
const AGENTS = [
  {
    ...
    desc: "Crafting cinema-quality interfaces using Next.js 15, React, and Tailwind CSS. Specialized in high-end animations using Framer Motion and GSAP.",
    stats: [{ v: "100%", l: "Responsive" }, { v: "60fps", l: "Smoothness" }],
    img: "images/1.png", // Keep original prismatic glass images
  },
  {
    label: "BACKEND",
    title: "Scalable Architecture",
    desc: "Building robust server-side logic with Node.js and TypeScript. Expertise in PostgreSQL database design, REST APIs, and secure authentication flows.",
    stats: [{ v: "99.9%", l: "Uptime" }, { v: "Type", l: "Safe" }],
    img: "images/2.png",
  },
  {
    label: "SYSTEMS",
    title: "Analysis & Quality Control",
    desc: "Experience in cold-chain logistics and IoT data analysis. Transforming complex operational requirements into streamlined software solutions.",
    stats: [{ v: "Real", l: "Time" }, { v: "4+ yrs", l: "Experience" }],
    img: "images/3.png",
  },
  {
    label: "TOOLS",
    title: "DevEx & Deployment",
    desc: "Streamlining development with Git, Docker, and CI/CD pipelines. Focused on clean code principles and efficient shipping workflows.",
    stats: [{ v: "Git", l: "Expert" }, { v: "Vercel", l: "Deploy" }],
    img: "images/4.png",
  },
]
